...
macro_rules! emergency {
    ...
    ($($arg:tt)*) => {
              $crate::externs::tracing::error!(log_level=$crate::log::tracing::entity::syslog::Severity::Emergency.as_int(), log_level_name=$crate::log::tracing::entity::syslog::Severity::Emergency.as_str(), $($arg)*);
          };
}
...
macro_rules! alert {
    ...
    ($($arg:tt)*) => {
        $crate::externs::tracing::error!(log_level=$crate::log::tracing::entity::syslog::Severity::Alert.as_int(), log_level_name=$crate::log::tracing::entity::syslog::Severity::Alert.as_str(), $($arg)*);
    };
}
...
macro_rules! critical {
    ...
    ($($arg:tt)*) => {
        $crate::externs::tracing::error!(log_level=$crate::log::tracing::entity::syslog::Severity::Critical.as_int(), log_level_name=$crate::log::tracing::entity::syslog::Severity::Critical.as_str(), $($arg)*);
    };
}
...
macro_rules! error {
    ...
    ($($arg:tt)*) => {
        $crate::externs::tracing::error!(log_level=$crate::log::tracing::entity::syslog::Severity::Error.as_int(), log_level_name=$crate::log::tracing::entity::syslog::Severity::Error.as_str(), $($arg)*);
    };
}
...
macro_rules! warning {
    ...
    ($($arg:tt)*) => {
        $crate::externs::tracing::warn!(log_level=$crate::log::tracing::entity::syslog::Severity::Warning.as_int(), log_level_name=$crate::log::tracing::entity::syslog::Severity::Warning.as_str(), $($arg)*);
    };
}
...
macro_rules! warn {
    ...
    ($($arg:tt)*) => {
        $crate::externs::tracing::warn!(log_level=$crate::log::tracing::entity::syslog::Severity::Warning.as_int(), log_level_name=$crate::log::tracing::entity::syslog::Warning.as_str(), $($arg)*);
    };
}
...
macro_rules! notice {
    ...
    ($($arg:tt)*) => {
        $crate::externs::tracing::info!(log_level=$crate::log::tracing::entity::syslog::Severity::Notice.as_int(), log_level_name=$crate::log::tracing::entity::syslog::Notice.as_str(), $($arg)*);
    };
}
...
macro_rules! debug {
    ...
    ($($arg:tt)*) => {
        $crate::externs::tracing::trace!(log_level=$crate::log::tracing::entity::syslog::Severity::Debug.as_int(), log_level_name=$crate::log::tracing::entity::syslog::Severity::Debug.as_str(), $($arg)*);
    };
}
