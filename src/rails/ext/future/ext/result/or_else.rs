...
impl<Fut, FutFunc, FuncOutput, T, E> OrElse<Fut, FutFunc, FuncOutput>
where
    Fut: Future<Output = Result<T, E>>,
    FutFunc: FnOnce(E) -> FuncOutput,
    FuncOutput: Future<Output = Result<T, E>>,
{
...
impl<Fut, FutFunc, FuncOutput, T, E> Future for OrElse<Fut, FutFunc, FuncOutput>
where
    Fut: Future<Output = Result<T, E>>,
    FutFunc: FnOnce(E) -> FuncOutput,
    FuncOutput: Future<Output = Result<T, E>>,
